...
const sources: SourceSeed[] = [
  {
    id: "hansard-debates",
    name: "Hansard debates API",
    category: "parliamentary-scrutiny",
    scope: "UK Parliament",
    owner: "UK Parliament",
    url: "https://hansard-api.parliament.uk/",
    licence: "Open Parliament Licence",
    officialStatus: "official",
    refreshCadence: "Published as the official report is finalised",
    newcomerExplanation: "The official record of what was actually said in Parliament, debate by debate.",
    compassScorePotential: "High — debate positions can be scored per speaker and party.",
    aggregateViewPotential: "AI debate summaries per bill, argument maps, speaker stance tracking.",
    caveats: "Transcripts are long; summaries must cite the original debate."
  },
  {
    id: "members-interests",
    name: "Register of Members' Financial Interests",
    category: "parliamentary-scrutiny",
    ...
    licence: "Open Parliament Licence",
    officialStatus: "official",
    refreshCadence: "Updated as members register interests",
    newcomerExplanation: "What MPs are paid, given, or hold outside Parliament — declared in their own register.",
    compassScorePotential: "Low directly; high for conflict-of-interest context on votes and debates.",
    aggregateViewPotential: "Per-MP interest panels, sector rollups, interest-vs-vote cross references.",
  ...
  },
  {
    ...
    category: "parliamentary-scrutiny",
    scope: "UK",
    owner: "Office of the Registrar of Consultant Lobbyists",
    url: "https://registerofconsultantlobbyists.org.uk/",
    licence: "Public register",
    officialStatus: "official",
    refreshCadence: "Quarterly returns",
    newcomerExplanation: "Who is being paid to lobby ministers and permanent secretaries, and for whom.",
    compassScorePotential: "Low directly; high as influence context around bills and departments.",
    aggregateViewPotential: "Lobbying activity per department and per bill subject area.",
    caveats: "Covers consultant lobbyists only — in-house lobbying is out of scope; no JSON API, import from the published register."
  },
  {
    id: "select-committees",
    name: "Select committee inquiries and evidence",
    category: "parliamentary-scrutiny",
    scope: "UK Parliament",
    owner: "UK Parliament",
    ...
    licence: "Open Parliament Licence",
    officialStatus: "official",
    refreshCadence: "Live as committees publish",
    newcomerExplanation: "Cross-party committees that grill ministers and publish evidence — Parliament's main scrutiny engine.",
    compassScorePotential: "Medium — recommendations and government responses can be scored.",
    aggregateViewPotential: "Department scrutiny feeds, AI-summarised evidence, inquiry-to-bill links.",
    caveats: "Evidence volumes are large; summarisation needs careful sourcing."
  },
  {
    id: "public-inquiries",
    ...
    category: "parliamentary-scrutiny",
    scope: "UK",
    owner: "HM Government (gov.uk)",
    url: "https://www.gov.uk/government/publications?content_store_document_type=independent_reports",
    licence: "Open Government Licence",
    officialStatus: "official",
    refreshCadence: "As inquiries publish reports",
    newcomerExplanation: "Statutory and independent inquiries into failures — Grenfell, infected blood, the Post Office and others.",
    compassScorePotential: "Medium — recommendations vs implementation can be tracked and scored.",
    aggregateViewPotential: "Inquiry recommendation trackers per department, implementation scorecards.",
    caveats: "No single API; reports arrive as documents that need per-inquiry import."
  },
  {
    id: "postcodes-io",
    name: "Postcodes.io",
